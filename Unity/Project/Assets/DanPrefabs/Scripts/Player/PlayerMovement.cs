...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class PlayerMovement : NetworkBehaviour
    {
        ...
        [SerializeField]
        private float sprintCostPerSecond = 2f;
        [SerializeField]
        ...
        private void Update()
        {
            ...
            {
                currentRegenCooldown = _regenCooldown;
                regenerateStamina = false;
            }

            staminaImage.fillAmount = GameManager.Instance.staminaLevel / GameManager.Instance.maxStamina;
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded)
            {
                ...
                if (m_Jump)
                {
                    ...
                    GameManager.Instance.staminaLevel -= jumpCost;
                }
            }
            else
            {
